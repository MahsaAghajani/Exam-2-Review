...
Implement a function called countWhich()
 which will take in a list of items and a callback,
  and it will return the number of elements 
  which return a truthy value from the callback function.

If the first argument is not an array, 
our function should return false instead of a number.
...
const countWhich = function(list, cb) {
  ...
  // for each elment we execute the callback, if it returns true, count the element
  let counter = 0;
